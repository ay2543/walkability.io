...
<style>
div.blue { background-color:grey; border-radius: 5px; padding: 20px;}
</style>
<div class = "blue">
...
The first step is to get a general understanding of the walkability index in the City by creating a descriptive choropleth map on the census tract level. We focused on the following counties:
