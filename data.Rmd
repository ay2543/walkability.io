...
* Variables of interest:
  ...
  * Physical inactivity
  * Mental health
  *Note: blood pressure status is based on physician diagnosis, physical health, physical inactivity and mental health are based on self-report*
...
* All variables were analyzed at the **census tract** level
  * Since walkability data was provided at a census block level (which is narrower than the census block level), we took the average walkability indices of census blocks within a census tract for analysis for consistency with geographic data for other variables.
